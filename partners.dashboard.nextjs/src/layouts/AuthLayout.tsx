                ...
                <div className="min-h-screen bg-[#f4f7fb] text-slate-900">
                        <div className="grid min-h-screen lg:grid-cols-[1.15fr_0.85fr]">
                                <div className="relative hidden overflow-hidden lg:flex flex-col justify-between p-10 xl:p-14 text-white bg-gradient-to-br from-[#0d1b3d] via-[#142449] to-[#091225]">
                                        ...
                                        <img src="@assets/Screenshot_2026-05-05_at_18.03.26_1778000624311.png" alt="Partner onboarding preview" className="absolute inset-0 h-full w-full object-cover opacity-20 mix-blend-screen" />
                                        <div className="relative z-10">
                                                <img src="/azapallogoV1.svg" alt="logo" className="h-8 w-auto" />
                                        </div>
                                        <div className="relative z-10 max-w-xl space-y-4">
                                                <p className="text-4xl font-semibold leading-tight">Seamless partner onboarding and login</p>
                                                <p className="max-w-lg text-sm leading-6 text-blue-100/80">A clean, secure flow for login, onboarding, and OTP verification built around the current brand colors.</p>
                                        </div>
                                </div>
