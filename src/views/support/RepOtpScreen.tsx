...
import { useVerifyRepOtp, useSendRepOtp } from "../../hooks/useRepAuth";

export default function RepOtpScreen() {
  ...
  const { mutate: verifyOtp, isPending } = useVerifyRepOtp();
  const { mutate: sendOtp, isPending: isResending } = useSendRepOtp();
